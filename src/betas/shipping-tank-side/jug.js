...
function pctJug(p) {
    ...
    html += "<g fill-rule='evenodd' fill='black' stroke='white' stroke-width='0'>\n";
    ...
    html += "<g stroke='white' stroke-width='3' fill-opacity='0.0'>\n";
    html += "<path d='M 30 20 L 80 20 L 80 50 Q 90 70 100 80 L 100 180 Q 55 200 10 180 L 10 80";
    html += "           Q 20 70 30 50 z' />\n";
    html += "</g>\n";

    // Upper Ellipse
    html += "<ellipse cx='55' cy='20' rx='25' ry='5' style='fill:#aaaaaa; stroke:white;";
    html += "         stroke-width:3'/>\n";
    ...
    // Text Percentage
    if (p.pct < 80) {
        html += "<text x='105' y='" + tPct + "' fill='white' class='svgText'>" + p.pct + "%</text>\n";
    } else {
        html += "<text x='85' y='" + tPct + "' fill='white' class='svgText'>" + p.pct + "%</text>\n";
    }
