$(document).ready(function() {
    ...
    $('#center-circle').on('click', function() {
        writeOutput('center-circle clicked');
    })
    $('#slice-1').click(function() {
        writeOutput('1 clicked');
    });
    $('#slice-2').click(function() {
        writeOutput('2 clicked');
    });
    $('#slice-3').click(function() {
        writeOutput('3 clicked');
    });
    $('#slice-4').click(function() {
        writeOutput('4 clicked');
    });
    $('#slice-5').click(function() {
        writeOutput('5 clicked');
    });
    $('#slice-6').click(function() {
        writeOutput('6 clicked');
    });    
});
